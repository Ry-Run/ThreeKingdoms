...
func (d *Dispatcher) registerAll() {
	...
	register(d, PH.HandleAssignArmyRequest)
}
...
func unwrapPlayerRequestBody(req *playerpb.PlayerRequest) proto.Message {
	...
	case *playerpb.PlayerRequest_DisposeRequest:
	...
	case *playerpb.PlayerRequest_AssignArmyRequest:
		return body.AssignArmyRequest
	default:
		return nil
	}
}
