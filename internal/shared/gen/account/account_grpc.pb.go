...
const (
	AccountService_Login_FullMethodName    = "/three_kingdoms.account.v1.AccountService/Login"
	AccountService_Register_FullMethodName = "/three_kingdoms.account.v1.AccountService/Register"
)
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "three_kingdoms.account.v1.AccountService",
